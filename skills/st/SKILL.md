...
测试跨特性交互。阅读 `reference/st-recipes.md` 获取语言相关模式与 real-vs-contract 测试分类。
...
- **性能**：在预期负载下测量 p50/p95/p99；吞吐量；内存/CPU/磁盘 I/O。基准工具见 `reference/st-recipes.md`。记录：测量值 vs SRS 阈值。
