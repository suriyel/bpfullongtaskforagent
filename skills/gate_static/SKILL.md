---
name: gate_static
description: 静态分析门 — 脚本门禁 review skill：运行 gate_static.cjs 校验产物，并按 OK/FAIL/BLOCKED 三态回报框架。
---

# 静态分析门

<!-- gate-wrapper: shared-scripts/gate_static.cjs -->
## 门禁校验（本节点唯一职责）
1. 运行校验脚本：`node {{SCRIPTS}}/gate_static.cjs`。
